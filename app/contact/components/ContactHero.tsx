  ...
  return (
    <section className="px-6 pb-10 pt-36 lg:px-8">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-[#191919]/75">
        ...
        <a
          href="#contact-form"
          className="mt-7 inline-flex h-11 items-center justify-center gap-2 rounded-lg bg-[#4F46E5] px-4 text-sm font-medium text-white shadow-[0_4px_0_#C8C6F7] transition-colors hover:bg-[#4338CA]"
        >
